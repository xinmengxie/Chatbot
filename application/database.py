...
FILE = "messages.db"
time_begin = datetime.now().strftime("%Y%m%d") + str(int(100 * np.random.rand(1)[0]))
PLAYLIST_TABLE = "Messages_{}".format(time_begin)
...
class DataBase:
    ...
    def __init__(self):
        ...
        self._create_table()
        self.save_message("AI", "Hi, how can I help you?")
